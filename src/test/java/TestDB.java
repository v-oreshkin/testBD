...
public class TestDB {
    ...
    public void testTS1(){
        ...
        StepsDB.insertPatternInDBAndCheckResultSteps(GlobalConstants.PATH_TO_SQL_PROPERTIES_FILE_FOR_CONNECT,ValuesFromPropertiesFiles
    ...
    public void testTS2() throws SQLException {
        ...
        StepsDB.getSelectUseWhereChangeDatesChangeAndUpdateSteps(GlobalConstants.PATH_TO_SQL_PROPERTIES_FILE_FOR_CONNECT,ValuesFromPropertiesFiles
